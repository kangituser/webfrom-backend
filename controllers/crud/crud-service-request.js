...
const createASR = async (req, res, next) => createASRequest(req, res);
...
const GetOpenASRs = (req, res, next) => findAllOpenASR(req.id, res);

const GetClosedASRs = (req, res, next) => findAllClosedASR(req.id, res);
